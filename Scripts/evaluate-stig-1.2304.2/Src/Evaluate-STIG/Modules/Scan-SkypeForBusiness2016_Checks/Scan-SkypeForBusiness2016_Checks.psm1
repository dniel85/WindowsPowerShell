...
# --------------------
# STIG:     Microsoft Skype for Business 2016
# Version:  V1R1
# Class:    UNCLASSIFIED
# Updated:  4/25/2023
...
Function Get-V70901 {
    ...
    .DESCRIPTION
        ...
        Rule Title : The ability to store user passwords in Skype must be disabled.
    #>
    ...
    $RegistryValueName = "savepassword"  # Value name identified in STIG
    ...
    $SettingName = "Allow storage of user passwords"  # GPO setting name identified in STIG
...
Function Get-V70903 {
    ...
    .DESCRIPTION
        ...
        Rule Title : Session Initiation Protocol (SIP) security mode must be configured.
    #>
...
Function Get-V70905 {
    ...
    .DESCRIPTION
        ...
        CCI ID     : CCI-001184
        Rule Name  : SRG-APP-000219
        Rule Title : In the event a secure Session Initiation Protocol (SIP) connection fails, the connection must be restricted from resorting to the unencrypted HTTP.
    #>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA8B2u8leEsGuHO
# vkgKpAR3Nll7aMHgOH+qHAIo7+24aaCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCatJWuTBeRFm8ErgmBZogINzV4m+nB
# B0Oqpqps3Xk9LTANBgkqhkiG9w0BAQEFAASCAQCcGMFKG6K0Ab0Y1P4NRESkzWqZ
# Sfy6u6HxEbs6/mHl2/Br/tB0jRUhzzF7Z+ZlFLSTvF9gW/KXZXrHQvt1LsuWhdH7
# q6l9/TI9bXzmF+fsqy1w4iLQtpx23DLVHugb/h0gYVJgRqpb5XM9pAKCj2vCyJie
# 8eQlo64R+BLE9KHPCSkccCKMw7iOSARW/9kd05eOmnniXFEUu44dFJHFAf8ZHRU1
# varApjcb20aV7fOAzZeGX0rerrPWIQMoEW7/aphuuhp2LgHgbMC8AlrSziLoEvNo
# DeWsc36SgdQuaQQeDFmqwzpx86RlToDrEFMIfGlBAmqRhXdCOeOajsVChoH6
