...
Function Get-V75263 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75263
        STIG ID    : ADBP-XI-000205
        Rule ID    : SV-89943r1_rule
        CCI ID     : CCI-001695, CCI-002530
        Rule Name  : SRG-APP-000112
        Rule Title : Adobe Acrobat Pro XI Enhanced Security for standalone mode must be enabled.
    #>
    ...
    $RegistryPath = "HKLM:\Software\Policies\Adobe\Adobe Acrobat\11.0\FeatureLockDown"  # Registry path identified in STIG
...
Function Get-V75265 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75265
        STIG ID    : ADBP-XI-000210
        Rule ID    : SV-89945r1_rule
        CCI ID     : CCI-001695, CCI-002530
        Rule Name  : SRG-APP-000112
        Rule Title : Adobe Acrobat Pro XI Enhanced Security for browser mode must be enabled.
    #>
...
Function Get-V75267 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75267
        STIG ID    : ADBP-XI-000275
        Rule ID    : SV-89947r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Adobe Acrobat Pro XI PDF file attachments must be blocked.
    #>
...
Function Get-V75269 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75269
        STIG ID    : ADBP-XI-000280
        Rule ID    : SV-89949r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Adobe Acrobat Pro XI access to unknown websites must be restricted.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = ""  # User's loaded hive to perform check
    $RegistryPath = "HKLM:\Software\Policies\Adobe\Adobe Acrobat\11.0\FeatureLockDown\cDefaultLaunchURLPerms\"  # Registry path identified in STIG
...
Function Get-V75271 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75271
        STIG ID    : ADBP-XI-000285
        Rule ID    : SV-89951r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Adobe Acrobat Pro XI access to websites must be blocked.
    #>
...
Function Get-V75273 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75273
        STIG ID    : ADBP-XI-000290
        Rule ID    : SV-89953r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Adobe Acrobat Pro XI must be configured to block Flash Content.
    #>
...
Function Get-V75275 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75275
        STIG ID    : ADBP-XI-000295
        Rule ID    : SV-89955r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : The Adobe Acrobat Pro XI send and Track plugin for Outlook must be disabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = ""  # User's loaded hive to perform check
    $RegistryPath = "HKLM:\Software\Policies\Adobe\Adobe Acrobat\11.0\FeatureLockDown\cCloud"  # Registry path identified in STIG
...
Function Get-V75277 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75277
        STIG ID    : ADBP-XI-000840
        Rule ID    : SV-89957r1_rule
        CCI ID     : CCI-001813
        Rule Name  : SRG-APP-000380
        Rule Title : Adobe Acrobat Pro XI privileged file and folder locations must be disabled.
    #>
...
Function Get-V75279 {
    ...
    .DESCRIPTION
        ...
        Rule Title : Adobe Acrobat Pro XI FIPS mode must be enabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Adobe\Adobe Acrobat\11.0\AVGeneral"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Adobe\Adobe Acrobat\11.0\AVGeneral"  # Registry path identified in STIG
...
Function Get-V75281 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75281
        STIG ID    : ADBP-XI-000990
        Rule ID    : SV-89961r1_rule
        CCI ID     : CCI-002470
        Rule Name  : SRG-APP-000427
        Rule Title : Adobe Acrobat Pro XI periodic downloading of Adobe European certificates must be disabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Adobe\Adobe Acrobat\11.0\Security\cDigSig\cEUTLDownload"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Adobe\Adobe Acrobat\11.0\Security\cDigSig\cEUTLDownload"  # Registry path identified in STIG
...
Function Get-V75285 {
    ...
    .DESCRIPTION
        ...
        Rule Title : Adobe Acrobat Pro XI Protected Mode must be enabled.
    #>
...
Function Get-V75287 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75287
        STIG ID    : ADBP-XI-001015
        Rule ID    : SV-89967r1_rule
        CCI ID     : CCI-002530
        Rule Name  : SRG-APP-000431
        Rule Title : Adobe Acrobat Pro XI Protected View must be enabled.
    #>
...
Function Get-V75293 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75293
        STIG ID    : ADBP-XI-001280
        Rule ID    : SV-89973r1_rule
        CCI ID     : CCI-001499
        Rule Name  : SRG-APP-000133
        Rule Title : Adobe Acrobat Pro XI Default Handler changes must be disabled.
    #>
...
Function Get-V75295 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75295
        STIG ID    : ADBP-XI-001285
        Rule ID    : SV-89975r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Adobe Acrobat Pro XI must disable the ability to store files on Acrobat.com.
    #>
...
Function Get-V75297 {
    ...
    .DESCRIPTION
        ...
        CCI ID     : CCI-001813
        Rule Name  : SRG-APP-000380
        Rule Title : Adobe Acrobat Pro XI certified document trust must be disabled.
    #>
    ...
    $TempUserHivePath = ""  # User's loaded hive to perform check
    $RegistryPath = "HKLM:\Software\Policies\Adobe\Adobe Acrobat\11.0\FeatureLockDown"  # Registry path identified in STIG
    $RegistryValueName = "bEnableCertificateBasedTrust"  # Value name identified in STIG
    $RegistryValue = @("0")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Certified Document Trust"  # GPO setting name identified in STIG
    $SettingState = "Disabled"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V75299 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75299
        STIG ID    : ADBP-XI-001330
        Rule ID    : SV-89979r1_rule
        CCI ID     : CCI-001813
        Rule Name  : SRG-APP-000380
        Rule Title : Adobe Acrobat Pro XI privileged host locations must be disabled.
    #>
    ...
    $TempUserHivePath = ""  # User's loaded hive to perform check
    $RegistryPath = "HKLM:\Software\Policies\Adobe\Adobe Acrobat\11.0\FeatureLockDown"  # Registry path identified in STIG
    $RegistryValueName = "bDisableOSTrustedSites"  # Value name identified in STIG
    $RegistryValue = @("1")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
...
Function Get-V75301 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75301
        STIG ID    : ADBP-XI-001325
        Rule ID    : SV-89981r1_rule
        CCI ID     : CCI-001813
        Rule Name  : SRG-APP-000380
        Rule Title : Adobe Acrobat Pro XI privileged site locations must be disabled.
    #>
    ...
    $RegistryValue = @("1")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Privileged site locations"  # GPO setting name identified in STIG
    $SettingState = "Disabled"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V75303 {
    ...
    .DESCRIPTION
        ...
        CCI ID     : CCI-002470
        Rule Name  : SRG-APP-000427
        Rule Title : Adobe Acrobat Pro XI Periodic downloading of Adobe certificates must be disabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Adobe\Adobe Acrobat\11.0\Security\cDigSig\cAdobeDownload"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Adobe\Adobe Acrobat\11.0\Security\cDigSig\cAdobeDownload"  # Registry path identified in STIG
    $RegistryValueName = "bLoadSettingsFromURL"  # Value name identified in STIG
    $RegistryValue = @("0")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
...
Function Get-V75305 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75305
        STIG ID    : ADBP-XI-001315
        Rule ID    : SV-89985r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Adobe Acrobat Pro XI SharePoint and Office365 Access must be disabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = ""  # User's loaded hive to perform check
    $RegistryPath = "HKLM:\Software\Policies\Adobe\Adobe Acrobat\11.0\FeatureLockDown\cSharePoint"  # Registry path identified in STIG
...
Function Get-V75307 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75307
        STIG ID    : ADBP-XI-001310
        Rule ID    : SV-89987r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : The Adobe Acrobat Pro XI Welcome Screen must be disabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = ""  # User's loaded hive to perform check
    $RegistryPath = "HKLM:\Software\Policies\Adobe\Adobe Acrobat\11.0\FeatureLockDown\cWelcomeScreen"  # Registry path identified in STIG
...
Function Get-V75309 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75309
        STIG ID    : ADBP-XI-001305
        Rule ID    : SV-89989r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Adobe Acrobat Pro XI Webmail must be disabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = ""  # User's loaded hive to perform check
    $RegistryPath = "HKLM:\Software\Policies\Adobe\Adobe Acrobat\11.0\FeatureLockDown\cWebmailProfiles"  # Registry path identified in STIG
...
Function Get-V75311 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75311
        STIG ID    : ADBP-XI-001300
        Rule ID    : SV-89991r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Adobe Acrobat Pro XI third-party web connectors must be disabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = ""  # User's loaded hive to perform check
    $RegistryPath = "HKLM:\Software\Policies\Adobe\Adobe Acrobat\11.0\FeatureLockDown\cServices"  # Registry path identified in STIG
...
Function Get-V75313 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75313
        STIG ID    : ADBP-XI-001290
        Rule ID    : SV-89993r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Adobe Acrobat Pro XI Adobe Cloud Synchronization must be disabled.
    #>
...
Function Get-V75315 {
    ...
    .DESCRIPTION
        Vuln ID    : V-75315
        STIG ID    : ADBP-XI-001295
        Rule ID    : SV-89995r1_rule
        CCI ID     : CCI-000381
        Rule Name  : SRG-APP-000141
        Rule Title : Adobe Acrobat Pro XI Adobe Repair Installation must be disabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = ""  # User's loaded hive to perform check
    $RegistryPathArr = @("HKLM:\SOFTWARE\Adobe\Adobe Acrobat\11.0\Installer", "HKLM:\SOFTWARE\Wow6432Node\Adobe\Adobe Acrobat\11.0\Installer")  # Registry path identified in STIG
...
Function Get-V79057 {
    ...
    .DESCRIPTION
        ...
        Rule Title : An unsupported Adobe Acrobat Pro version must not be installed.
    #>
    ...
    ForEach ($Version in $XIVersions) {
        Switch ($Version) {
            "XI" {
                $NewObj = [PSCustomObject]@{
                    Version = $Version
                    EoS     = (Get-Date -Date 10/15/2017)
                }
            }
        }
        $EoSDates.Add($NewObj)
    ...
    $Installs = Get-AdobeReaderProInstalls | Where-Object {$_.Name -like "Adobe Acrobat*" -and $_.Version -eq "XI"}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDKutImVMLp8CMd
# tpLc2xplWfdc4577meJmhrO3lhKzTaCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBwPgSIxawgASKxp+T45vsQens4kZZy
# Sq0jqVtUpufQPTANBgkqhkiG9w0BAQEFAASCAQBDEUrwHOTmuzAxyxOmMdTXhbIc
# dxiavw1jEU4+TMbhkpN8u8o9Cc2e3po9nRvmgjJ4lIzkpWrOUHAAsVg5CPUSK0qa
# ccM69S9XPSScDTuW6g0j4CDUnZFWk27cAsITaVsHplxmTxBd+LXjU/kr2WiOYUfd
# xYSU5OpfuSQRiulCe6xIi6JhmtAwIZpg0LETq+QbsEQnQi2AkVoyz1z9bWdISb2+
# C8MWJKeE00zEfd6gknriaqpXvdvsEEJ1mhXPeuSwT+zluHZS+Kstao0BYf5BOzyX
# p5xGrfpwRfOWG1EjqDbplslsG567zizXNoG8oddI8+HOImD2cMDecIsF3FEd
