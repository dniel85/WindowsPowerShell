...
Function Get-V40730 {
    ...
    .DESCRIPTION
        Vuln ID    : V-40730
        STIG ID    : DTOO104
        Rule ID    : SV-52788r1_rule
        CCI ID     : CCI-001170
        Rule Name  : DTOO104 - Disabling of user name and password
    ...
    $RegistryValueName = "visio.exe"  # Value name identified in STIG
...
Function Get-V40731 {
    ...
    .DESCRIPTION
        Vuln ID    : V-40731
        STIG ID    : DTOO111
        Rule ID    : SV-52789r1_rule
        CCI ID     : CCI-001695
        Rule Name  : DTOO111 - IE Bind to Object
...
Function Get-V40736 {
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\policies\Microsoft\office\15.0\Visio\security"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\software\policies\Microsoft\office\15.0\Visio\security"  # Registry path identified in STIG
...
Function Get-V40738 {
    ...
    .DESCRIPTION
        Vuln ID    : V-40738
        STIG ID    : DTOO131
        Rule ID    : SV-52796r1_rule
        CCI ID     : CCI-001749
        Rule Name  : DTOO131 - Trust Bar Notifications
        Rule Title : Trust Bar Notifications for unsigned applications must be disabled.
    #>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCnn7WwDoM8/7mJ
# e7bxp9NCQ/iCJTa7pz6X8OTqCaq83qCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDBCgzTSYfYRSGBnsvdwvRdgBn95H5+
# faR28M0WsJF60DANBgkqhkiG9w0BAQEFAASCAQCbMt4d2oxjgH9qSpOgM32ROuo7
# KL/VYwBnnlX3cxH6Mp+59yV4bDYKi33OC8HX2/60MlLKhgIetmi5JWEnX6LOEpSp
# tcqRc7Wv6VHOmbozb2QulbTmtwVz2dta+/BKtvD1tQEDz8irqzKRRBrGa8B+76xE
# l2Q0vY3iFCtHxFOZ1jnFVd/IrmDHlre9NzbK6O5kclAK9pWA9Ar+ej71iDOXnO6t
# hdZ4k7XnddX4xkBTWSz/Fce5MtZq9v2G2AKLwMZnZbd7xF5D6UZXkkwvhxB66Zro
# cVJ8TmfkE3txQ+z5avuIh982rCOpu3B5+m/45qwZJyV/IRiXNfbuYDF8Zv00
