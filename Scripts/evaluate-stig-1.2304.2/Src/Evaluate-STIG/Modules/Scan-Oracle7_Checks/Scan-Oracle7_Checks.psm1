...
Function Get-V221707 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221707r877392_rule
        CCI ID     : CCI-002165, CCI-002235
        Rule Name  : SRG-OS-000324-GPOS-00125
        Rule Title : The Oracle Linux operating system must prevent non-privileged users from executing privileged functions to include disabling, circumventing, or altering implemented security safeguards/countermeasures.
    #>
...
'@
    ...
    $filelist | ForEach-Object {
        ...
        if (grep -s $_.split(" ")[-1] /home/*/ --directories=skip  --include='.*' -R) {
            $found++
        }
    }
...
Function Get-V221753 {
    ...
    #---=== Begin Custom Code ===---#
    $(systemctl | grep kdump.service && systemctl status kdump.service)
...
Function Get-V221758 {
    ...
    if ($finding) {
        if (Test-Path /boot/grub2/grub.cfg) {
            ...
            $finding_2 = $(grep -s fips /boot/efi/EFI/redhat/grub.cfg)
        }
...
Function Get-V221762 {
    ...
    if (($finding -match "/boot/grub2/") -or ($finding -match "/boot/efi/EFI/redhat/")) {
...
Function Get-V221840 {
    ...
    if ($finding) {
        if (Test-Path /boot/grub2/grub.cfg) {
            ...
            $finding = $(grep -s fips /boot/efi/EFI/redhat/grub.cfg)
        }
...
Function Get-V221849 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221849r853721_rule
        CCI ID     : CCI-001133, CCI-002361
        Rule Name  : SRG-OS-000163-GPOS-00072
        Rule Title : The Oracle Linux operating system must be configured so that all network connections associated with SSH traffic are terminated at the end of the session or after 10 minutes of inactivity, except to fulfill documented and validated mission requirements.
    #>
...
Function Get-V221851 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-221851r603260_rule
        CCI ID     : CCI-001133
        Rule Name  : SRG-OS-000163-GPOS-00072
        Rule Title : The Oracle Linux operating system must be configured so that all network connections associated with SSH traffic terminate after a period of inactivity.
    #>
...
Function Get-V221867 {
    ...
    #---=== Begin Custom Code ===---#
    $finding = $(grep -s -iR ^net.ipv4.tcp_invalid_ratelimit /etc/sysctl.conf /etc/sysctl.d/ /run/sysctl.d/ /usr/local/lib/sysctl.d/ /usr/lib/sysctl.d/ /lib/sysctl.d/)
    $finding ?? $($finding = "Check text: No results found.")
    ...
    if ($finding.count -eq $foundcount-1){
        $finding_2 = $(/sbin/sysctl -a | grep -s net.ipv4.tcp_invalid_ratelimit)
        $finding_2 ?? $($finding_2 = "Check text: No results found.")
...
Function Get-V250309 {
    ...
    .DESCRIPTION
        ...
        Rule ID    : SV-250309r877392_rule
        CCI ID     : CCI-002165, CCI-002235
        Rule Name  : SRG-OS-000324-GPOS-00125
        Rule Title : The Oracle Linux operating system must must confine SELinux users to roles that conform to least privilege.
    #>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCfes3l/BQh94I3
# df5uGOQmtCPfKPDRe+XpKMqDFRvlk6CCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCB0K5xUruQHGh1/NwsWn8VKLQnqZdiH
# 0uRw0/NVW2YwjjANBgkqhkiG9w0BAQEFAASCAQAFlm+wWZrEOSiAGwtvGLcCQ6Nn
# 5ZLbfuXDmSD/qsTzEAsarIq1UZ6V+AB2gXaYUtEO87BjYPCqGcUdBkcD9hmw0MjO
# hXPngM7nR7slGjkm7PGY6EEiNL1TvZQ1emwAzV6ghCs7GnJB3nObH9g4PqnuWfoW
# H4ZdfgKTTfNQaeNe1ms1kJXrFAN9BjUXM6YHXc89Ew15NWvQozQfpFtaMJ9zqexw
# /clnQ6wU94fxM3KmD9wb2tZvQCneF13jRvO3zFXJCH4q0agO1VB4kMTcoJx4k9nl
# sU+kAQYqZ430vMQDzQ+cAwX0XFkdBXbvP87Fzf5vSw0UCG4lu7htuAabw6v2
