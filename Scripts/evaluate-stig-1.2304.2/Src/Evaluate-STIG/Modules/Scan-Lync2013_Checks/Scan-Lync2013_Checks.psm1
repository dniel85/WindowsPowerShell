...
Function Get-V40776 {
    ...
    .DESCRIPTION
        ...
        CCI ID     : CCI-000196
        Rule Name  : DTOO420 - Store user passwords
        Rule Title : The ability of Lync to store user passwords must be disabled.
    #>
    ...
    $RegistryPath = "HKLM:\Software\Policies\Microsoft\office\15.0\lync"  # Registry path identified in STIG
...
Function Get-V40777 {
    ...
    .DESCRIPTION
        Vuln ID    : V-40777
        STIG ID    : DTOO421
        Rule ID    : SV-52835r1_rule
        CCI ID     : CCI-001184
        Rule Name  : DTOO421 - Session Initiation Protocol (SIP) security mode
...
Function Get-V40778 {
    ...
    .DESCRIPTION
        ...
        CCI ID     : CCI-001184
        Rule Name  : DTOO422 - Session Initiation Protocol (SIP)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA45WOP11lVfES2
# OPzROXTJFvyZmtAmzpmku5xYwKCSPKCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDqFz/e7Te9cAaeOqgG38LJ3eKS0wr8
# A1z9MUxMr7yxGjANBgkqhkiG9w0BAQEFAASCAQDKrByu0QmMDt+9OX1cSEnHh6Ms
# trfCGOoOR7VTueIX7ZxdtxKDB2n4WHF33h6Fio0CYjTq0cZxraV2t7E8d7u++OZU
# 5emciKTHnEfkyeJsjZsJQl7yYmnZj6TzvWfSnDcZevt8vc0JbwXLyy7i+TCEV7Ya
# Cz0sNTNFxgixVX/mGwegG6eMBdrA+FS/SE11HeHVaDu0MakCNFfI1tAvbpe16Q5b
# SG4w2GQ5kGXSeJDKlFCL3182/l7ZZDGyd27JWiLlYn2srI1RtJtMwZP00jyTZvfG
# tQk6fEz0DAjuvSOSR4OCponMHxoIlt+lMNhY/m0Giar1QXympFpGUeKx0WdR
