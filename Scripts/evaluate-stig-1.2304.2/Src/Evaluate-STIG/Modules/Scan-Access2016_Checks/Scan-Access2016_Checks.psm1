...
Function Get-V70907 {
    ...
    $SettingState = "Enabled: (msaccess.exe)"  # GPO configured state identified in STIG.
...
Function Get-V70939 {
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\16.0\access\internet"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\Office\16.0\access\internet"  # Registry path identified in STIG
...
Function Get-V70947 {
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\16.0\access\settings"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\Office\16.0\access\settings"  # Registry path identified in STIG
    $RegistryValueName = "Default File Format"  # Value name identified in STIG
    $RegistryValue = @("C")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDEdHmAmI8/pYaS
# dtWJPytkAYB9CmPxf1BfqShLztcjRKCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCA7J7CrEt71t1Y6HqsnHdJnS6FJWcRU
# P1xpc1nQbiq4yTANBgkqhkiG9w0BAQEFAASCAQC/V7CuYqg7FdX0Iau65XBw7Opc
# xWOXox4ISrk37iT8XAxZazbdNcuzccQiFVMQgTmLXHYV05pFdNlxbH7rECIiWl7U
# GPR758sEYuS3gjtbFZxDEYmXysUo6VkDKDcnzjS/s4EBijAVzSiY9RM1qUb01gS4
# ENESgt65BCJSHR/POf+hVJfVwPP8BuoHj0hD1j5ViBh6qv68GHiMJTxK5rE4bnUb
# qBc0diLt16QT3iPlfBgwuxgoww9QJrm2iOw+DCBCqcspWbaBZSqUZdkB2zk/tlvV
# UTGCRGKUTstujfenu7RenD14gdbUs/6yIUM5UgF/2XMX8pxOek18g8oB6Sq5
