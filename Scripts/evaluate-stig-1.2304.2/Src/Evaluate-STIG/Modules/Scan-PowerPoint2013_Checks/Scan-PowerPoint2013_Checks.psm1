...
# --------------------
# STIG:     Microsoft PowerPoint 2013
# Version:  V1R6
# Class:    UNCLASSIFIED
# Updated:  4/25/2023
...
Function Get-V17187 {
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\policies\Microsoft\office\15.0\powerpoint\security"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\software\policies\Microsoft\office\15.0\powerpoint\security"  # Registry path identified in STIG
...
Function Get-V17322 {
    ...
    .DESCRIPTION
        Vuln ID    : V-17322
        STIG ID    : DTOO210
        Rule ID    : SV-53513r1_rule
        CCI ID     : CCI-001764
        Rule Name  : DTOO210 - Block opening of pre-release versions
        Rule Title : The opening of pre-release versions of file formats new to PowerPoint 2013 through the Compatibility Pack for Office 2013 and PowerPoint 2013 Converter must be blocked.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\policies\Microsoft\office\15.0\PowerPoint\security\fileblock"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\software\policies\Microsoft\office\15.0\PowerPoint\security\fileblock"  # Registry path identified in STIG
    $RegistryValueName = "powerpoint12betafilesfromconverters"  # Value name identified in STIG
    $RegistryValue = @("1")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Block opening of pre-release versions of file formats new to PowerPoint 2013 through the Compatibility Pack for Office 2013 and PowerPoint 2013 Converter"  # GPO setting name identified in STIG
    $SettingState = "Enabled"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V17471 {
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\15.0\PowerPoint\security\trusted locations"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Policies\Microsoft\Office\15.0\PowerPoint\security\trusted locations"  # Registry path identified in STIG
...
Function Get-V17473 {
    ...
    .DESCRIPTION
        Vuln ID    : V-17473
        STIG ID    : DTOO142
        Rule ID    : SV-53498r1_rule
        CCI ID     : CCI-001170
        Rule Name  : DTOO142 - Force Scan Encr. Macros in open XML
        Rule Title : Enforce encrypted macros to be scanned in open XML documents must be determined and configured.
    #>
...
Function Get-V17521 {
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\15.0\PowerPoint\options"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Policies\Microsoft\Office\15.0\PowerPoint\options"  # Registry path identified in STIG
    $RegistryValueName = "DefaultFormat"  # Value name identified in STIG
    $RegistryValue = @("27")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
...
Function Get-V17752 {
    ...
    .DESCRIPTION
        Vuln ID    : V-17752
        STIG ID    : DTOO290
        Rule ID    : SV-53522r1_rule
        CCI ID     : CCI-000366
        Rule Name  : DTOO290 - Make Hidden marks visible in PowerPoint
        Rule Title : Hidden markup options must be visible.
    #>
    ...
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\15.0\PowerPoint\options"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Policies\Microsoft\Office\15.0\PowerPoint\options"  # Registry path identified in STIG
    $RegistryValueName = "MarkupOpenSave"  # Value name identified in STIG
    $RegistryValue = @("1")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Make hidden markup visible"  # GPO setting name identified in STIG
    $SettingState = "Enabled"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V17788 {
    ...
    .DESCRIPTION
        ...
        CCI ID     : CCI-001170
        Rule Name  : DTOO289 - Running programs in PowerPoint
    ...
    $SettingState = "Enabled (disable - (don't run any programs))"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V17809 {
    ...
    .DESCRIPTION
        ...
        CCI ID     : CCI-001169
        Rule Name  : DTOO291 - Linked images
        Rule Title : Automatic download of linked images must be disallowed.
    #>
    ...
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\15.0\PowerPoint\security"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Policies\Microsoft\Office\15.0\PowerPoint\security"  # Registry path identified in STIG
    $RegistryValueName = "DownloadImages"  # Value name identified in STIG
    $RegistryValue = @("0")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Unblock automatic download of linked images"  # GPO setting name identified in STIG
    $SettingState = "Disabled"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V26592 {
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\15.0\PowerPoint\security\filevalidation"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Policies\Microsoft\Office\15.0\PowerPoint\security\filevalidation"  # Registry path identified in STIG
...
Function Get-V26614 {
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\15.0\PowerPoint\security\protectedview"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Policies\Microsoft\Office\15.0\PowerPoint\security\protectedview"  # Registry path identified in STIG
...
Function Get-V26639 {
    ...
    .DESCRIPTION
        Vuln ID    : V-26639
        STIG ID    : DTOO319
        Rule ID    : SV-53533r1_rule
        CCI ID     : CCI-000366
        Rule Name  : DTOO319 - Disable Slide Update
        Rule Title : The configuration for Slide Update with counterparts must be disallowed.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\15.0\PowerPoint\slide libraries"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Policies\Microsoft\Office\15.0\PowerPoint\slide libraries"  # Registry path identified in STIG
    $RegistryValueName = "DisableSlideUpdate"  # Value name identified in STIG
    $RegistryValue = @("1")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Disable Slide Update"  # GPO setting name identified in STIG
    $SettingState = "Enabled"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V42327 {
    ...
    .DESCRIPTION
        Vuln ID    : V-42327
        STIG ID    : DTOO501
        Rule ID    : SV-54944r1_rule
        CCI ID     : CCI-001170
        Rule Name  : DTOO501 - Disable user name and password in PowerPoint Viewer
...
Function Get-V42328 {
    ...
    .DESCRIPTION
        Vuln ID    : V-42328
        STIG ID    : DTOO510
        Rule ID    : SV-54946r1_rule
        CCI ID     : CCI-002460
        Rule Name  : DTOO510 - Restrict ActiveX Install in PowerPoint Viewer
...
Function Get-V42329 {
    ...
    .DESCRIPTION
        Vuln ID    : V-42329
        STIG ID    : DTOO509
        Rule ID    : SV-54948r1_rule
        CCI ID     : CCI-001695
        Rule Name  : DTOO509 - Zone Elevation Protection in PowerPoint Viewer
...
Function Get-V42330 {
    ...
    .DESCRIPTION
        Vuln ID    : V-42330
        STIG ID    : DTOO507
        Rule ID    : SV-54949r1_rule
        CCI ID     : CCI-001662
        Rule Name  : DTOO507 - Block Pop-Ups in PowerPoint Viewer
        Rule Title : File Links that invoke instances of Internet Explorer from within an Office product must be blocked in PowerPoint Viewer.
    #>
...
Function Get-V42331 {
    ...
    .DESCRIPTION
        Vuln ID    : V-42331
        STIG ID    : DTOO508
        Rule ID    : SV-54950r1_rule
        CCI ID     : CCI-001169
        Rule Name  : DTOO508 - Restrict File Download in PowerPoint Viewer
...
Function Get-V42332 {
    ...
    .DESCRIPTION
        Vuln ID    : V-42332
        STIG ID    : DTOO502
        Rule ID    : SV-54951r1_rule
        CCI ID     : CCI-001695
        Rule Name  : DTOO502 - Enable IE Bind to Object in PowerPoint Viewer
...
Function Get-V42333 {
    ...
    .DESCRIPTION
        Vuln ID    : V-42333
        STIG ID    : DTOO503
        Rule ID    : SV-54952r1_rule
        CCI ID     : CCI-001170
        Rule Name  : DTOO503 - Saved from URL in PowerPoint Viewer
...
Function Get-V42334 {
    ...
    .DESCRIPTION
        Vuln ID    : V-42334
        STIG ID    : DTOO504
        Rule ID    : SV-54953r1_rule
        CCI ID     : CCI-001170
        Rule Name  : DTOO504 - Block Navigation to URL from Office in PowerPoint Viewer
...
Function Get-V42335 {
    ...
    .DESCRIPTION
        Vuln ID    : V-42335
        STIG ID    : DTOO505
        Rule ID    : SV-54954r1_rule
        CCI ID     : CCI-001695
        Rule Name  : DTOO505 - Scripted Window Security in PowerPoint Viewer
...
Function Get-V42336 {
    ...
    .DESCRIPTION
        Vuln ID    : V-42336
        STIG ID    : DTOO506
        Rule ID    : SV-54955r1_rule
        CCI ID     : CCI-001662
        Rule Name  : DTOO506 - Add-on Management in PowerPoint Viewer
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDztz7d61slp3iG
# O5nBR2Pe1Wkx6GqhpKRNH6/DKNfWhqCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCADYMVoK9Nrbx757rDK58uhySI2mWSN
# WyBQUPV55g1PbDANBgkqhkiG9w0BAQEFAASCAQA/YE+Y8OQTOpGPE0xP2ByNK1Z+
# Xhfbv7eRD++OdpsJmfzmi/aQnIH4SRpLjCcGVeZvj09PfS/MPZQVY7ArjSYC7AcW
# vrJhJJD+FtqWoKEMbZppLyCAC8NwxoMrchBIZJJiux/3mVRtqNjR32O/dwj8aRTv
# Kxwo1BhG7UyY1SWGAyVsuWyy23QuSTKhsqsHpSXPYrtAwZSXIsFKDtPI/PHSgjgn
# F3wPrvnqCloQzf9s3Kmemss+gbrRYlbMyzCfV31dZad+UekdoN5K3P7wjfvlu5OJ
# jckuOD0t3m+TT/OsCgzmBEx4l81CvOzGHr10nddrl6yOd6jUWqAEIcSwjIgm
