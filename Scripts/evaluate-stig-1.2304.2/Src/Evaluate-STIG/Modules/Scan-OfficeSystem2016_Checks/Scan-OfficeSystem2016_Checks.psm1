...
# --------------------
# STIG:     Microsoft Office System 2016
# Version:  V2R2
# Class:    UNCLASSIFIED
# Updated:  4/25/2023
...
Function Get-V238024 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238024
        STIG ID    : DTOO182
        Rule ID    : SV-238024r650639_rule
        CCI ID     : CCI-000366
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\16.0\common\ptwatson"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\Office\16.0\common\ptwatson"  # Registry path identified in STIG
...
Function Get-V238025 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238025
        STIG ID    : DTOO186
        Rule ID    : SV-238025r650642_rule
        CCI ID     : CCI-001662
...
Function Get-V238026 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238026
        STIG ID    : DTOO187
        Rule ID    : SV-238026r650645_rule
        CCI ID     : CCI-002476
...
Function Get-V238027 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238027
        STIG ID    : DTOO188
        Rule ID    : SV-238027r650648_rule
        CCI ID     : CCI-001199
...
Function Get-V238029 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238029
        STIG ID    : DTOO190
        Rule ID    : SV-238029r650654_rule
        CCI ID     : CCI-001199
        Rule Name  : SRG-APP-000231
...
Function Get-V238030 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238030
        STIG ID    : DTOO191
        Rule ID    : SV-238030r650657_rule
        CCI ID     : CCI-002460
...
Function Get-V238031 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238031
        STIG ID    : DTOO192
        Rule ID    : SV-238031r811512_rule
        CCI ID     : CCI-001662
        Rule Name  : SRG-APP-000207
...
Function Get-V238032 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238032
        STIG ID    : DTOO193
        Rule ID    : SV-238032r650663_rule
        CCI ID     : CCI-001170
...
Function Get-V238033 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238033
        STIG ID    : DTOO196
        Rule ID    : SV-238033r650666_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
...
Function Get-V238034 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238034
        STIG ID    : DTOO197
        Rule ID    : SV-238034r650669_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
...
Function Get-V238035 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238035
        STIG ID    : DTOO201
        Rule ID    : SV-238035r650672_rule
        CCI ID     : CCI-002235
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\16.0\common\drm"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\Office\16.0\common\drm"  # Registry path identified in STIG
...
Function Get-V238036 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238036
        STIG ID    : DTOO206
        Rule ID    : SV-238036r650675_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\16.0\common\fixedformat"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\Office\16.0\common\fixedformat"  # Registry path identified in STIG
...
Function Get-V238038 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238038
        STIG ID    : DTOO408
        Rule ID    : SV-238038r650681_rule
        CCI ID     : CCI-000381
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\office\16.0\common\broadcast"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\office\16.0\common\broadcast"  # Registry path identified in STIG
...
Function Get-V238039 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238039
        STIG ID    : DTOO409
        Rule ID    : SV-238039r650684_rule
        CCI ID     : CCI-001170
        Rule Name  : SRG-APP-000210
...
Function Get-V238040 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238040
        STIG ID    : DTOO410
        Rule ID    : SV-238040r650687_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\office\16.0\common\feedback"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\office\16.0\common\feedback"  # Registry path identified in STIG
...
Function Get-V238041 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238041
        STIG ID    : DTOO412
        Rule ID    : SV-238041r650690_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
        Rule Title : The ability to run unsecure Office web add-ins and Catalogs must be disabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\office\16.0\wef\trustedcatalogs"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\office\16.0\wef\trustedcatalogs"  # Registry path identified in STIG
    $RegistryValueName = "requireserververification"  # Value name identified in STIG
    $RegistryValue = @("1")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Allow Unsecure web add-ins and Catalogs"  # GPO setting name identified in STIG
    $SettingState = "Disabled"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V238042 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238042
        STIG ID    : DTOO416
        Rule ID    : SV-238042r650693_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\office\16.0\osm"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\office\16.0\osm"  # Registry path identified in STIG
...
Function Get-V238043 {
    <#
    .DESCRIPTION
        Vuln ID    : V-238043
        STIG ID    : DTOO601
        Rule ID    : SV-238043r650696_rule
        CCI ID     : CCI-000366
        Rule Name  : SRG-APP-000516
        Rule Title : The ability to send personal information to Office must be disabled.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\office\16.0\common"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\office\16.0\common"  # Registry path identified in STIG
    $RegistryValueName = "sendcustomerdata"  # Value name identified in STIG
    $RegistryValue = @("0")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Send personal information"  # GPO setting name identified in STIG
    $SettingState = "Disabled"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCClqlzAZyBAthal
# QJyOKDC6t1CY1qEjl8AGhZE3RiDICKCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDmdtRJdpLwqsyPIXIRcey2DF5H8tK4
# zYZRE4JBE5UxSjANBgkqhkiG9w0BAQEFAASCAQAv2CukdtQ7EhPzhPoHhR8F7Xgq
# omIFP+pJVdamfgoWSdcFI6sFORC3YgBSnSuLH4SNbIRCIHiPFbFh/A6BN2CB7l2r
# 2Svt3YN2G91qSuK0xfVTqwuMjwEMAT613zjIF7hOdNVt5z4he4RxzvX0+vAHHgIc
# jA4CWpLBAZET0tpk+JWBEyYdVFyURaiZ5t2f1fCjcLg3nCa8a4aW/wt/uCBqu9DL
# yktDkqPrrqH8AL8arEkuthFqow8AHKk5LYeLKC/y8RrhY12yFNrnlhYIl8mV9VKT
# csm1Vic1IUrs1yZc6/6n/WirT9Va9k/2Xxoc/WXvYnlhT8GHzAFy8n5JyloP
