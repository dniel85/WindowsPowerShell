...
Function Get-V70955 {
    ...
    $SettingState = "Enabled: (excel.exe)"  # GPO configured state identified in STIG.
...
Function Get-V71011 {
    ...
    $RegistryValue = @("33")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDgiuFbzZiAzGo3
# RWeRmoEBEdfOUaEp4K+jkMn6kpLo8aCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCoen2nZZAnTnv1GcldOIE0C32JqLgX
# EOuu4m3lS7gyEzANBgkqhkiG9w0BAQEFAASCAQC6u/BIt1Efk31uhevJ7E9Lbjug
# yl5TTzKD05R+XTRzGMk8YFywmXme1DcYX3Xd2ewdif9zwg7Lox4NQ0abU1zfypPT
# LdGN8cBW15zMA/pGZf7mc4I4hWXmMasdsPMI8AjYiRfgJ8w98hT0aKKkRGzTKx4u
# 6e+glB+gZu0YDnrpMRDoXlqmdY+CS8UDyU6Ao/TlfKT1h1iomoKyN3Lm2PxI3msh
# PI0NAssW2aGYtDq6YsOFHBtJMROBCRUSSd6+aZHZdfMjn42oi+B8Jr1VkXIaVQQc
# oEkOhdEmFxNNjR/8uctOV7CaY59MraSwp48JfEq+lSMqhoLK/RmTQ5PoVWyc
