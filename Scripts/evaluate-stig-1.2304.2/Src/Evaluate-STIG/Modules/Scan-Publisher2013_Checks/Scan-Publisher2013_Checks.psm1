...
Function Get-V17173 {
    ...
    $RegistryValueName = "mspub.exe"  # Value name identified in STIG
...
Function Get-V17187 {
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\15.0\publisher\security"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Policies\Microsoft\Office\15.0\publisher\security"  # Registry path identified in STIG
...
Function Get-V17545 {
    ...
    $SettingState = "Enabled (Disabled all with notifications)"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V26584 {
    ...
    $RegistryValue = @("1")  # Value expected in STIG (if REG_DWORD/REG_QWORD use hex and remove leading 0x000...)
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = ""  # GPO setting name identified in STIG
    $SettingState = ""  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
Function Get-V26707 {
    ...
    .DESCRIPTION
        Vuln ID    : V-26707
        STIG ID    : DTOO322
        Rule ID    : SV-53255r1_rule
        CCI ID     : CCI-001662
        Rule Name  : DTOO322 - Prompt files to open instead of blocking
        Rule Title : Fatally corrupt files must be blocked from opening.
    #>
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\15.0\publisher"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\Software\Policies\Microsoft\Office\15.0\publisher"  # Registry path identified in STIG
    $RegistryValueName = "PromptForBadFiles"  # Value name identified in STIG
...
Function Get-V26708 {
    ...
    .DESCRIPTION
        ...
        CCI ID     : CCI-001170
        Rule Name  : DTOO323 - Publisher Automation Security Level
        Rule Title : The Publisher Automation Security Level must be configured for high security.
    #>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCMwNOEYmpFFJay
# HOVGTnKLYu5SvTPwiNvGJCd2rumsPKCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBpp9JOaSWxUVcLiLut/dQjLwnslrVC
# tr538hsS376l6zANBgkqhkiG9w0BAQEFAASCAQB+F6pRuEEMR6wPguX8FK7ow2Yr
# KrbeOZrpuP+6l9Gn/wvMV2YQMH2KOwLQzlhnnmKqoFovUNcjtzh/hY4UHpQq1FxQ
# 5o3ngaoEWFaWkesk6zQXg/QbLqceeIZHQD6yg0vAQ9qQYWZ1PtdjaNY2CKMddvUI
# P4B6HtdlAAanng6uC5WNdveN8GWfSuVkD12eoYzOjVyEINVzDj4FLuNTpRmeBLnU
# oLBAOABRFql9m+IfxXCJoj0wgveS6FqrOkOQBx4d7HoBosUfO4kI5zUFGmHkimqR
# 0q2K9hndntSh2ti3vdJjgVWxKNmNW0z0Jgc1asB/0m3WpRZ6Bp6bQwqHlj0w
