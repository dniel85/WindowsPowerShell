...
Function Get-V70729 {
    ...
    $SettingState = "Enabled: (mspub.exe)"  # GPO configured state identified in STIG.
...
Function Get-V71673 {
    ...
    #---=== Begin Custom Code ===---#
    $TempUserHivePath = "Registry::HKU\Evaluate-STIG_UserHive\SOFTWARE\Policies\Microsoft\Office\16.0\publisher"  # User's loaded hive to perform check
    $RegistryPath = "HKCU:\SOFTWARE\Policies\Microsoft\Office\16.0\publisher"  # Registry path identified in STIG
    ...
    $RegistryType = "REG_DWORD"  # Value type expected in STIG
    $SettingName = "Prompt to allow fatally corrupt files to open instead of blocking them"  # GPO setting name identified in STIG
...
Function Get-V71675 {
    ...
    $SettingState = "Enabled: (High (Disabled))"  # GPO configured state identified in STIG.
    $SettingNotConfiguredAllowed = $false  # Set to true if STIG allows for setting to be Not Configured.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDa+J/lL+bkNwlH
# EUzuAmq7Yj6gNipwxjt44wSgmkmA9KCCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCC+L5YEy3vhwE3G2mwFs621oYd3pOY3
# 51TBezH1nwBKwjANBgkqhkiG9w0BAQEFAASCAQAbS0dV07FaRt7B7dNRv+I7wydq
# Gh7rlo6vI0DAK4jqKNLW9FMYp9RtHicYa8S1mj36ffKR7IKiVeiNSA00w0zUhuuE
# 2SIuGElWFCPALca0AsJoo/PMRPNGsaRGIygyBl4FSx27NuVB1EFzx4u3+zw60KCk
# Vdq0ULBVgENTt9LmO6DOqK0bN78fAzLNCa4M4kuzAkJDMvIwdjmo6YyWKVpQ1QE+
# pzSiZoDz4Buwdyi5atkEAH+/TSDTk7Pg7J9JT3ao1aW+YyZqBC7U1AOc37Ix6B/4
# oPzWvb8MHkFgJjM0cGhEK+4ksBrL+Wgmp8MOKN3iEJt34ayMcAWhqU+Ekya8
