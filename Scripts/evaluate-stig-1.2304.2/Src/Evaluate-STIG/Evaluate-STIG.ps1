...
Process {
    ...
    Try {
        If ($PsBoundParameters.SelectVuln) {
            $TempVulns = $PsBoundParameters.SelectVuln -split ","
            ForEach ($Item in $TempVulns) {
        ...
        ElseIf ($PsBoundParameters.ExcludeVuln) {
            $TempVulns = $PsBoundParameters.ExcludeVuln -split ","
            ForEach ($Item in $TempVulns) {
                If ($Item -notmatch "^V-\d{4,6}$") {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA0Ks/SYJYL8BTF
# GoPKAofwZEGAYVqOCWTWxHzk3qlxz6CCCTswggR6MIIDYqADAgECAgQDAgTXMA0G
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBMvB6tR+UAzv3TNPgWLFfZkF3V2kfj
# wVTTq4Wb0aIo3DANBgkqhkiG9w0BAQEFAASCAQAaVF49k7EItekCsjrFhoW1Truj
# I5W/G2fDUt0N4UOl8hkYQLzoWov3lJ2n6ycdcD9SYt4N8J5fCRhEgeuj09Z0GZe3
# Ds3ff1QriwSxxFSqRFfB865IbgFNHRcf8doUyMDqvYiNnz9cNDJ5ZJcAaeiTAKGT
# /ObAkpRPTawTp89JHNaUtMZtUcwqnYEfTOggIlbXAvHkEjkgu6RoUkZGAJV5qR6f
# izy0Vrr9O9e82yuubsUXTbDnmZbXfnTuk2OZO9vufJmikTFs2k0spE7FFWZoKYCQ
# y50v1EugkYMejpjfwxoLd9wYyP3kBhpa5JhyfKyqTOOeDkx0hhLJDeAU304Z
